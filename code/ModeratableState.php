...
class ModeratableState extends Object {
	public $default_moderation_score = 1.0;
	public $default_spam_score = 10.0;
	...
	public $moderationState = "approved";

	private $stateStack = array();

	public function push_state($state) {
		$this->stateStack[] = $this->moderationState;
		$this->moderationState = $state;
	}

	public function pop_state() {
		$this->moderationState = array_pop($this->stateStack);
	}
}
